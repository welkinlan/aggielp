		...
		<div class="hero-unit span5 offset4" style="padding: 15px 15px 10px 15px; border-radius: 6px ">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <h5>Email</h5>
                            <input name="email" type="text" class="form-control span5" placeholder="Password" 
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input name="password_conf" type="password" class="form-control span5" placeholder="Confirm password " 
